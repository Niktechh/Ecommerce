...
export default function Placeorder(){
  ...
  const {backendUrl, getCartAmount, delivery_fee, token, cartItems, setcartItems, products } = useContext(ShopContext);
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={() => setMethod('stripe')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              ...
              <img className='h-5 mx-4' src={assets.stripe_logo.src} alt='Stripe' />
            </div>
